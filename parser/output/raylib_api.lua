return {
  ...
  functions = {
    ...
    {
      name = "InitWindowPro",
      description = "Initialize a new window and OpenGL context and return it's context",
      returnType = "int",
      params = {
        {type = "int", name = "width"},
        {type = "int", name = "height"},
    ...
    {
      name = "SetActiveWindowContext",
      description = "Set the active window context",
      returnType = "int",
      params = {
        {type = "int", name = "windowId"}
      }
    },
    {
      name = "CloseWindow",
